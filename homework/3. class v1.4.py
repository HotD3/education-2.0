         ...
         #   new_name = self.name.replace(" ", '')
           ...
           if new_name in name:
              ...
              break
               ...
               print(f'No, your name is {new_name} not correct')
__version__ = '1.4'
        
Nikolay_v2().check()
'''Создание функции, которая запускает цикл. Во время выполнения цикла предлагает ввести значение переменной new_name. После этого
